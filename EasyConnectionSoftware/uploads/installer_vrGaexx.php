...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = 'GWM_Export_fdb80fb62ec3f3452322_20231002093108_archive.zip';
        const ARCHIVE_SIZE       = '192922323';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = 'fdb80fb-02093108';
        const SECONDARY_PACKAGE_HASH = '2b0cd0b-02093108';
